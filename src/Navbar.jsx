...
function Navbar(){
    ...
    return(
        <div className="sm:flex bg-[#d4af37] gap-9 w-full sm:h-11 text-center pt-1  sm:justify-center pb-2" >
            <div>
            ...
            <div>
                <Link to='/portfolio' className='hover:text-white hover:border-white transition-all duration-300 border-b-2 border-black sm:border-none'>Portfolio</Link>
            </div>
            <div>
